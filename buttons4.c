...
//    but_value[RESET] = (GPIOPinRead (RESET_PORT_BASE, GPIO_PIN_6) == GPIO_PIN_6);
...
uint8_t checkSwitch()
{
    ...
    switchState = (GPIOPinRead(SW1_PORT_BASE, SW1_PIN) == SW1_PIN);
